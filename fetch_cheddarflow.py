...
async def fetch_cheddarflow_posts():
    ...
    async with async_playwright() as p:
        ...
        while scroll_count < max_scrolls:
            ...
            # Check if we've reached July 2025 or earlier
            if posts_data:
                try:
                    latest_date = datetime.fromisoformat(posts_data[-1]['date'].replace('Z', '+00:00'))
                    if latest_date < datetime(2025, 8, 1):
                        print("Reached posts from July 2025 or earlier. Stopping.")
                        break
                except:
                    pass
